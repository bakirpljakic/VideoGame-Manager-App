...
import com.example.videogame.GameData
import com.example.videogame.HomeActivity
...
class TestLayout {
    ...
    fun recyclerViewTest() {
        onView(withId(R.id.game_list)).perform(RecyclerViewActions.scrollToPosition<ViewHolder>(0))
            .check(
                matches(
                    allOf(
        ...
        onView(withId(R.id.game_list)).perform(RecyclerViewActions.scrollToPosition<ViewHolder>(0))
            .check(
                matches(hasDescendant(withId(R.id.game_title_textview)).also {
                    isTopAlignedWith(
        ...
        onView(withId(R.id.game_list)).perform(RecyclerViewActions.scrollToPosition<ViewHolder>(0))
            .check(
                matches(hasDescendant(withId(R.id.game_rating_textview)).also {
                    isCompletelyLeftOf(
